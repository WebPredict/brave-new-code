...
public interface UserDao {
	...
	String	generateNewUserConfirmCode (String userId);
	
	boolean	checkUserConfirmCode (String userId, String code);
	...
	void	saveAlerts (User user, List<Alert> recs) throws SQLException;
	
	void	removeAlerts (User user, List<Long> recIds) throws SQLException;
	...
	void	inheritRatingsFrom (User fromUser, User toUser) throws SQLException;
	
	void 	updateWebStats(User user, String url, int numKeystrokes, int time) throws SQLException;
